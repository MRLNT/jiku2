                        ...
                        <div class="col-xxl-12">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="numeric1">Nomor Notas</label>
                                ...
                                <div class="form-group">
                                    <label for="numeric4">Umur Pensiun</label>
                                    <input name="umur_pengajuan" type="text" class="form-control autonumber" id="numeric4" placeholder="Masukkan Umur Pensiun Anda">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <h5>Jenis Suku Bunga</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="FLAT" id="FLAT" value="FLAT">
                                        <label class="form-check-label" for="FLAT">
                                        FLAT
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="ANUITAS BULANAN" id="ANUITAS BULANAN" value="ANUITAS BULANAN">
                                        <label class="form-check-label" for="ANUITAS BULANAN">
                                        ANUITAS BULANAN
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="SLIDING BULANAN" id="SLIDING BULANAN" value="SLIDING BULANAN">
                                        <label class="form-check-label" for="SLIDING BULANAN">
                                        SLIDING BULANAN
                                        </label>
                                    </div>
                                </div>
