                        ...
                        <div class="col-md-12 m-b-30">
                            ...
                            <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                <div class="page-title mb-2 mb-sm-0">
                                    <h1>DATA FINAL ASN PRAPENSIUN</h1>
                                </div>
                            </div>
                            <!-- end page title -->
                        </div>
                        ...
                        <div class="col-xxl-12">
                            <div class="card card-statistics">
                                <form action="" method="post">
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql1 = "SELECT * FROM data_kredit_prapensiun WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $sql2 = "SELECT * FROM data_kredit_prapensiun WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql3 = "SELECT * FROM data_kredit_prapensiun WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql4 = "SELECT * FROM data_kredit_prapensiun WHERE id_pengajuan = $edit_id";
                                    ...
                                    <?php
                                        $sql6 = "SELECT * FROM data_kredit_prapensiun WHERE id_pengajuan = $edit_id";
