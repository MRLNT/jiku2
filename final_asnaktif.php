                        ...
                        <div class="col-lg-12 ">
                            <div class="card card-statistics">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $sql = "SELECT id_pengajuan, nama_marketing, nama_debitur FROM data_kredit_asnaktif";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td><a href="final_asnaktif_check?edit_id=' . $row['id_pengajuan'] . '" class="btn btn-info">Edit</a></td>';
                                            echo '</tr>';
                                        }
                                        echo '</table>';
                                    } else {
