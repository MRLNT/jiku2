                        ...
                        <div class="col-xxl-12">
                            <div class="card card-statistics">
                                <form action="" method="post">
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql1 = "SELECT * FROM data_kredit_asnaktif WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $sql2 = "SELECT * FROM data_kredit_asnaktif WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql3 = "SELECT * FROM data_kredit_asnaktif WHERE id_pengajuan = $edit_id";
                                    ...
                                    <div class="card-body">
                                        <?php
                                        $sql4 = "SELECT * FROM data_kredit_asnaktif WHERE id_pengajuan = $edit_id";
                                    ...
                                    <?php
                                        $sql6 = "SELECT * FROM data_kredit_asnaktif WHERE id_pengajuan = $edit_id";
